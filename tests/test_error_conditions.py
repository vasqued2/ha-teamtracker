...
from custom_components.teamtracker.set_values import async_set_universal_values, async_set_team_values, async_set_in_values
...
async def test_error_conditions(hass):
    ...
    rc = await parser.async_set_values({}, {}, 0, 0, 0, {}, "en", "sensor_name")
    assert rc is False

...
The automations.yaml file contains an automation that can be manually triggers to dump the sensor data.

Copy the desired .json file to /share/tt/test.json
Insert the corresponding .yaml file into the configuration.yaml file to create the test sensors.

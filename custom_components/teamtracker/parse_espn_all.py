...
class EspnAllParser(EspnParser):
    ...
    def finalize_sensor_values(self, provider_response) -> bool:
        ...
        #
        # 1. altGameNote: ESPN's own human-readable competition label for
        #    this competition (e.g. "English Premier League", "LALIGA",
        #    "Carabao Cup, Second Round"). Preferred because it already
        #    covers cases the season slug can't, such as cup rounds whose
        #    slug is just "second-round" with no competition name in it.
        ...
        self._values.league_name = self._alt_game_note or ""

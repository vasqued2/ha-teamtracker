...
from .provider_factory import (
    ...
    get_provider)
from .utils import is_integer, async_call_espn_api, has_team
...
#  key = "{sport}:{league}:{team_id}"
    ...
    async def async_get_team_schedule(self):
        ...
        today = date.today()
        cached = TeamTrackerCoordinator.all_team_cache.get(cache_key)
        ...
        TeamTrackerCoordinator.all_team_cache[cache_key] = result
        return result

...
class TeamTrackerScoresSensor(CoordinatorEntity):
    ...
    def __init__(self, hass: HomeAssistant, entry: ConfigEntry) -> None:
        ...
        self._opponent_linescores = None
    ...
    def extra_state_attributes(self):
        ...
        attrs["team_linescores"] = self.coordinator.data["team_linescores"]
        ...
        attrs["opponent_linescores"] = self.coordinator.data["opponent_linescores"]
